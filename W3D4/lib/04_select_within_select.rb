...
def neighbors_of_certain_b_countries
  ...
  #return country name and continuent,
  #look in country table
    # SELECT name, continent
    # FROM countries
    # WHERE continent = 'Americas' OR continent = 'Europe'
end

#US, Americas if Americas also include 'canada'
...
def sparse_continents
  # Find the countries in a continent has pop lower than 25,000,000
